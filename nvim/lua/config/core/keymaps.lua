...
keymap.set("n", "<ESC>", ":nohl<CR>", options)
keymap.set("n", "<leader>k", "7zl", options)
keymap.set("n", "<leader>j", "7zh", options)
keymap.set("n", "<leader>hk", ":vsplit ~/.config/nvim/lua/config/core/keymaps.lua<CR>", options)
keymap.set("n", "<leader>oi", ":lua require('jdtls').organize_imports()<CR>", options)
-- keymap.set("n", "<leader>ev", ":lua require('jdtls').extract_variable()<CR>", options)
-- keymap.set("n", "<leader>ec", ":lua require('jdtls').extract_constant()<CR>", options)
-- keymap.set("n", "<leader><leader>em", "lua require('jdtls').extract_method(true)<CR>", options)
...
keymap.set("n", "<leader>e", ":NvimTreeFindFileToggle<CR>", options) -- toggle file explore, optionsr
